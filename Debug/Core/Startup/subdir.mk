...
Core/Startup/startup_stm32l052t8yx.o: ../Core/Startup/startup_stm32l052t8yx.s Core/Startup/subdir.mk
	arm-none-eabi-gcc -mcpu=cortex-m0plus -g3 -c -I../Mantarray/inc -x assembler-with-cpp -MMD -MP -MF"Core/Startup/startup_stm32l052t8yx.d" -MT"$@" --specs=nano.specs -mfloat-abi=soft -mthumb -o "$@" "$<"
